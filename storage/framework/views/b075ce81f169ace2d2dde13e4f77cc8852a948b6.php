    ...
    <div class="container inner_container">
        ...
        <div class="row">
            <div class="col text-center question_block">
                ...
                <p><a href="tel:+77777777777">+7 777 77 77 777</a> (WhatsApp)</p>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\webdev\htdocs\tuttobene\resources\views/pages/partners.blade.php ENDPATH**/ ?>