    ...
    <div class="container inner_container">
            ...
            <div class="col-lg-8 col-xl-7">
                ...
                <?php endif; ?>
                    <add-to-cart-single
                        ...
                        price="<?php echo e(number_format(setting('site.waffle_price'),0,'',' ')); ?>"
                        product-id="waffle"
                        product-type="waffle"
                        portion-id="waffle"
                    ></add-to-cart-single>
        ...
        <div class="row preim_block">
            ...
            <div class="col-6 col-lg-3">
                <div class="preim">
                    <picture>
                        <img src="/storage/image-texts/September2021/1AsGAVxIT6Ia2XdpTn8w.svg" alt="">
                    </picture>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>" id="<?php echo e($category->slug); ?>"
                            ...
                            <div class="owl-carousel owl-carousel3 owl-theme">
                                <?php $__currentLoopData = $category->icecreams()->where('id','<>',$product->id)->take(8)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item">
                                        <div class="tovar_image">
                                            <div class="tovar_info">
                                                <div class="container-fluid">
                                                    <div class="row align-items-md-center text-end text-md-center">
                                                        <div class="col">
                                                            <div>
                                                                <a href="<?php echo e(route('products.showInfo',[\App\Models\Icecream::ICECREAM, $otherProduct->slug])); ?>">Подробнее</a>
                                            ...
                                            <picture>
                                                ...
                                                <source srcset="<?php echo e(Voyager::image($otherProduct->image)); ?>"
                                                        type="image/jpg"/>
                                                <img src="<?php echo e(Voyager::image($otherProduct->image)); ?>"
                                                     alt="<?php echo e($otherProduct->title); ?>">
                                            </picture>
                                        </div>
                                        <a href="<?php echo e(route('products.showInfo',[\App\Models\Icecream::ICECREAM, $otherProduct->slug])); ?>"
                                ...
                                <div class="item">
                                    <div class="tovar_image">
                                        <div class="tovar_info">
                                            <div class="container-fluid">
                                                <div class="row align-items-md-center text-end text-md-center">
                                                    <div class="col">
                                                        <div>
                                                            <a href="<?php echo e(route('products.showInfo',[\App\Models\Icecream::ICECREAM, $popularProduct->slug])); ?>">Подробнее</a>
                                        ...
                                        <picture>
                                            ...
                                            <source srcset="<?php echo e(Voyager::image($popularProduct->image)); ?>"
                                                    type="image/jpg"/>
                                            <img src="<?php echo e(Voyager::image($popularProduct->image)); ?>"
                                                 alt="<?php echo e($popularProduct->title); ?>">
                                        </picture>
                                    </div>
                                    <a href="<?php echo e(route('products.showInfo',[\App\Models\Icecream::ICECREAM, $popularProduct->slug])); ?>"
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/0/004/domains/tutto.testkz.ru/resources/views/catalog/ice-cream-info.blade.php ENDPATH**/ ?>