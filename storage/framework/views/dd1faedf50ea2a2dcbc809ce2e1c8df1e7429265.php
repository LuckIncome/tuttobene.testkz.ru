        ...
        <tr>
            <td style="border: 1px solid #ccc;width: 110px">
                <img style="width: 100px"
                     src="<?php echo e($product->type != 'custom' ? \Voyager::image($product->image) : env('APP_URL').'/img/ic_2.svg'); ?>"
                     class=""/>
            </td>
...
<?php /**PATH D:\webdev\htdocs\tuttobene\resources\views/emails/newOrder.blade.php ENDPATH**/ ?>