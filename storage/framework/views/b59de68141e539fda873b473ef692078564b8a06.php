                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $dataTypeContent->sortBy('status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if($showCheckboxColumn): ?>
                                            <td>
                                        ...
                                        <?php endif; ?>
                                        <td>
                                            <a href="/admin/orders/<?php echo e($data->id); ?>/edit">#<?php echo e($data->id); ?></a>
                                        </td>
                                        <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <td>
                                                ...
                                                <?php elseif($row->type == 'text'): ?>
                                                    <?php if($row->field == 'confirmed'): ?>
                                                        <div class="readmore"><?php echo e(($data->{$row->field}) ? 'Да' : 'Нет'); ?></div>
                                                    <?php elseif($row->field == 'status'): ?>
                                                        <?php
                                                            switch ($data->{$row->field}){
                                                                case 1: $dataStatus = 'Новый заказ';break;
                                                                case 2: $dataStatus = 'Выполняется';break;
                                                                case 3: $dataStatus = 'Выполнен';break;
                                                                case 4: $dataStatus = 'Отменен';break;
                                                                default: $dataStatus = 'Неопределен';break;
                                                            }
                                                        ?>
                                                        <div class="readmore"><?php echo e($dataStatus); ?></div>
                                                    <?php elseif($row->field == 'delivery'): ?>
                                                        <div class="readmore"><?php echo e(($data->{$row->field} == 'self') ? 'Самовывоз' : 'Доставка'); ?></div>
                                                    <?php elseif($row->field == 'payment'): ?>
                                                        <div class="readmore">
                                                            <?php
                                                                switch ($data->{$row->field}){
                                                                    case 'cash': $dataStatus = 'Наличными';break;
                                                                    case 'card': $dataStatus = 'Онлайн оплата (Оплачено)';break;
                                                                    case 'charge': $dataStatus = 'Счет на оплату';break;
                                                                }
                                                            ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/0/004/domains/tutto.testkz.ru/resources/views/vendor/voyager/orders/browse.blade.php ENDPATH**/ ?>