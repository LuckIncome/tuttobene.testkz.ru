                    ...
                    <div class="col">
                        <div class="row align-items-center">
                            <div class="col-lg-4 text-center">
                                <picture>
                                    <img src="<?php echo e(Voyager::image($mainBlock->icon)); ?>" alt="">
                                </picture>
                            </div>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\webdev\htdocs\tuttobene\resources\views/pages/material.blade.php ENDPATH**/ ?>