                            ...
                            <div class="owl-carousel owl-carousel3 owl-theme">
                                @foreach($category->icecreams()->where('id','<>',$product->id)->take(8)->get() as $otherProduct)
                                    <div class="item">
                                            ...
                                            <div class="tovar_info">
                                                <div class="container-fluid">
                                                    <div class="row align-items-md-center text-end text-md-center">
                                                        <div class="col">
                                                            <div>
                                                                <a href="{{route('products.showInfo',[\App\Models\Icecream::ICECREAM, $otherProduct->slug])}}">Подробнее</a>
                                        ...
                                        <a href="{{route('products.showInfo',[\App\Models\Icecream::ICECREAM, $otherProduct->slug])}}"
                        ...
                        <div class="owl-carousel owl-carousel3 owl-theme">
                            @foreach($popularProducts as $popularProduct)
                                <div class="item">
                                        ...
                                        <div class="tovar_info">
                                            <div class="container-fluid">
                                                <div class="row align-items-md-center text-end text-md-center">
                                                    <div class="col">
                                                        <div>
                                                            <a href="{{route('products.showInfo',[\App\Models\Icecream::ICECREAM, $popularProduct->slug])}}">Подробнее</a>
                                    ...
                                    <a href="{{route('products.showInfo',[\App\Models\Icecream::ICECREAM, $popularProduct->slug])}}"
