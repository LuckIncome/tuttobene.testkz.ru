...
{{--                                    {{csrf_field()}}--}}
{{--                                    <div class="col-md-4">--}}
{{--                                        <label for="from-date">Начало</label>--}}
{{--                                        <input id="from-date" type="date" name="from" class="form-control" placeholder="01.01.2017"--}}
{{--                                               required>--}}
{{--                                    </div>--}}
{{--                                    <div class="col-md-4">--}}
{{--                                        <label for="to-date">Конец</label>--}}
{{--                                        <input id="to-date" type="date" name="to" class="form-control" placeholder="01.01.2017"--}}
{{--                                               required>--}}
{{--                                    </div>--}}
{{--                                    <input type="submit" class="btn btn-primary col-md-4" style="margin-top: 25px;" value="Экспорт">--}}
{{--                                </form>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        @if ($isServerSide)
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                @foreach($dataTypeContent->sortBy('status') as $data)
                                    <tr>
                                        @if($showCheckboxColumn)
                                            <td>
                                        ...
                                        @endif
                                        <td>
                                            <a href="/admin/orders/{{$data->id }}/edit">#{{$data->id}}</a>
                                        </td>
                                        @foreach($dataType->browseRows as $row)
                                            @php
                                            ...
                                            <td>
                                                ...
                                                @elseif($row->type == 'text')
                                                    @if($row->field == 'confirmed')
                                                        <div class="readmore">{{ ($data->{$row->field}) ? 'Да' : 'Нет' }}</div>
                                                    @elseif($row->field == 'status')
                                                        ...
                                                        @endphp
                                                        <div class="readmore">{{$dataStatus}}</div>
                                                    @elseif($row->field == 'delivery')
                                                        <div class="readmore">{{ ($data->{$row->field} == 'self') ? 'Самовывоз' : 'Доставка' }}</div>
                                                    @elseif($row->field == 'payment')
                                                        <div class="readmore">
                                                            @php
                                                                switch ($data->{$row->field}){
